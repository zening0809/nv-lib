 ...
 * 
 */
export default function multiply(number1: number | string, number2: number | string): string {
...
* Add decimal point
*/
function adjustDecimal(number: string, decimal: number): string {
	if (decimal == 0)
		return number;
	else {
...
function trailZero(number: string): string {
	while (number[0] == '0') {
