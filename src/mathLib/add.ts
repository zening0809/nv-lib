 ...
 * 
 */
export default function add(number1: string | number, number2: string | number = '0'): string {
    ...
    if (number1[0] == '-') {
        ...
        negLen = number1.length;
    }
    if (number2[0] == '-') {
        neg++;
        ind = 2;
        number2 = number2.substring(1);
        negLen = number2.length;
    }
...
function compliment(number: string): string {
    let s = ''
...
export function pad(number1: string, number2: string): string[]{
...
function addCore(number1: string, number2: string): string {
